...
public class registerActivity extends AppCompatActivity {
    ...
    private EditText editTextName, editTextEmail, editTextPassword, editTextPhone,editTextcPassword,editTextName2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextName2=findViewById(R.id.departmentName2);
